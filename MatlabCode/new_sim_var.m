...
%         SNR_est_mean = mean(others_test.SNR_est_list);
%         SNR_est_h_mean = mean(others_test.SNR_est_h_list);
%         SNR_pred_e_mean = mean(exhaustive.SNR);
%         SNR_pred_h_mean = mean(hierarchical.SNR);
