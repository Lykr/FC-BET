...
yyaxis right;
ylim([0.001, 1]);
plot(x, n_o_e_list./length(y_test), '--o', 'LineWidth', lineWidth, 'MarkerSize', 8);
plot(x, n_o_h_list./length(y_test), '--x', 'LineWidth', lineWidth, 'MarkerSize', 8);
plot(x, n_o_l_e_list./length(y_test), '--^', 'LineWidth', lineWidth, 'MarkerSize', 8);
plot(x, n_o_l_h_list./length(y_test), '--*', 'LineWidth', lineWidth, 'MarkerSize', 8);
