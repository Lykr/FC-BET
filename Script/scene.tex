...
\tikzset {_wdcc3tqbs/.code = {\pgfsetadditionalshadetransform{ \pgftransformshift{\pgfpoint{0 bp } { 0 bp }  }  \pgftransformrotate{-265 }  \pgftransformscale{2 }  }}}
\pgfdeclarehorizontalshading{_k9pr6z6iw}{150bp}{rgb(0bp)=(1,1,1);
rgb(37.5bp)=(1,1,1);
...
\tikzset {_1bftuo7xm/.code = {\pgfsetadditionalshadetransform{ \pgftransformshift{\pgfpoint{0 bp } { 0 bp }  }  \pgftransformrotate{-73 }  \pgftransformscale{2 }  }}}
\pgfdeclarehorizontalshading{_alj5urw0m}{150bp}{rgb(0bp)=(1,1,1);
rgb(37.5bp)=(1,1,1);
rgb(62.5bp)=(0.29,0.56,0.89);
rgb(100bp)=(0.29,0.56,0.89)}
...
\draw    (382.82,250.64) -- (382.82,226.86) -- (260.2,226.86) ;
\draw [shift={(258.2,226.86)}, rotate = 360] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Shape: Regular Polygon [id:dp9427611315548852] 
\path  [shading=_k9pr6z6iw,_wdcc3tqbs] (399.45,162.89) .. controls (401.94,112.62) and (402.01,113.29) .. (402.01,113.29) .. controls (402.01,113.29) and (402.01,113.29) .. (414.17,161.44) .. controls (426.34,209.59) and (396.95,213.15) .. (399.45,162.89) -- cycle ; % for fading 
...
\path  [shading=_alj5urw0m,_1bftuo7xm] (415.4,287.93) .. controls (421.65,311.82) and (421.61,311.49) .. (421.61,311.49) .. controls (421.61,311.49) and (421.61,311.49) .. (422.62,287.15) .. controls (423.62,262.8) and (409.15,264.04) .. (415.4,287.93) -- cycle ; % for fading 
...
% Text Node
\draw (444.52,322.68) node [anchor=north west][inner sep=0.75pt]    {$x$};
% Text Node
\draw (179.53,56.93) node [anchor=north west][inner sep=0.75pt]    {$y$};
% Text Node
\draw (182.53,318.92) node [anchor=north west][inner sep=0.75pt]    {$0$};
% Text Node
\draw (166.87,86.37) node [anchor=north west][inner sep=0.75pt]    {$100$};
% Text Node
\draw (174.26,106.25) node [anchor=north west][inner sep=0.75pt]    {$80$};
% Text Node
\draw (407.95,322.3) node [anchor=north west][inner sep=0.75pt]    {$100$};
% Text Node
\draw (376.59,322.43) node [anchor=north west][inner sep=0.75pt]    {$80$};
% Text Node
\draw (369.01,135.4) node   [align=left] {BS};
% Text Node
\draw (359.59,183.4) node   [align=left] {Beam};
% Text Node
\draw (323.36,240.4) node   [align=left] {Direction of travel};
% Text Node
\draw (354.19,290.4) node   [align=left] {Vehicle};
