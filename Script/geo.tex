...
% Text Node
\draw (242.66,221.17) node [anchor=north west][inner sep=0.75pt]    {$\theta _{n}$};
% Text Node
\draw (352.38,62.23) node [anchor=north west][inner sep=0.75pt]    {$\phi _{n}$};
% Text Node
\draw (307.59,101.15) node [anchor=north west][inner sep=0.75pt]    {$\omega _{n}$};
% Text Node
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ]  (286.77,160.79) -- (311.77,160.79) -- (311.77,187.79) -- (286.77,187.79) -- cycle  ;
\draw (289.77,165.19) node [anchor=north west][inner sep=0.75pt]    {$d_{n}$};
% Text Node
\draw (349.52,193.16) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{c} /2$};
% Text Node
\draw (402.4,87.8) node [anchor=north west][inner sep=0.75pt]    {$\beta _{n}$};
% Text Node
